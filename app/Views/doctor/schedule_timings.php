					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
                            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                <span class="user-img">
                                    <!-- Check if data is not empty and only retrieve the first entry -->
                                        <img class="rounded-circle" src="<?= base_url('uploads/' . $doctor['Profile_url']) ?>" width="31" alt="User Image">
                                </span>
                            </a>
                            <!-- Move the dropdown menu outside of the loop -->
                            <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <!-- Add links specific to each doctor -->
